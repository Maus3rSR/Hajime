...
export const N8N_URL: string = import.meta.env.VITE_N8N_URL as string
export const N8N_FEEDBACK_PATH: string = import.meta.env.VITE_N8N_FEEDBACK_PATH as string
