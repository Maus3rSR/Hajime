const state = {
    ...
    LAST_POOL_OFFSET: parseInt(process.env.ELECTRON_WEBPACK_APP_LAST_POOL_OFFSET, 10), // The last pool can have a difference of X entrances maximum (minus or plus)
}
